...
# %%
@t.compile
def compiled_training_step(transform, en_embed, fr_embed, loss_module, optim):
    """Compiled training step for performance optimization.

    Args:
        transform: The transformation module being optimized.
        en_embed: The input embeddings tensor.
        fr_embed: The target embeddings tensor.
        loss_module: The loss function module.
        optim: The optimizer.
