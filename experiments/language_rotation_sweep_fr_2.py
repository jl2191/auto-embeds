...
# %%
model_configs = [
    ("bloom-560m", False, False),
    ("bloom-560m", True, False),
    ("bloom-560m", True, True),
    ("bloom-3b", False, False),
    ("bloom-3b", True, False),
    ("bloom-3b", True, True),
    ("gpt2-small", False, False),
    ("gpt2-small", True, False),
    ("gpt2-small", True, True),
    ("gpt2-xl", False, False),
    ("gpt2-xl", True, False),
    ("gpt2-xl", True, True),
    ("mistral-7b", False, False),
    ("mistral-7b", True, False),
    ("mistral-7b", True, True),
]

for model_name, layernorm, no_processing in model_configs:
    run_sweep_for_model(model_name, layernorm, no_processing)
