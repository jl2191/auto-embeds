...
input_file = repo_path_to_abs_path("datasets/muse/en-fr/3_filtered/en-fr.json")
output_file = repo_path_to_abs_path("datasets/muse/en-fr/4_azure_validation/en-fr.json")
